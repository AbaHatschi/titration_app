...
@override
String toString() {
  return 'KegLineDto(id: $id, pLye1: $pLye1, mLye1: $mLye1, pLye2: $pLye2, mLye2: $mLye2, mAcid: $mAcid, lyeConcentration1: $lyeConcentration1, lyeSoda1: $lyeSoda1, lyeConcentration2: $lyeConcentration2, lyeSoda2: $lyeSoda2, acidConcentration: $acidConcentration, timeStamp: $timeStamp)';
}
...
/// @nodoc
abstract mixin class $KegLineDtoCopyWith<$Res>  {
  factory $KegLineDtoCopyWith(KegLineDto value, $Res Function(KegLineDto) _then) = _$KegLineDtoCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$KegLineDtoCopyWithImpl<$Res>
    implements $KegLineDtoCopyWith<$Res> {
  _$KegLineDtoCopyWithImpl(this._self, this._then);

  final KegLineDto _self;
  final $Res Function(KegLineDto) _then;
...
/// Adds pattern-matching-related methods to [KegLineDto].
extension KegLineDtoPatterns on KegLineDto {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _KegLineDto value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _KegLineDto() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _KegLineDto value)  $default,){
final _that = this;
switch (_that) {
case _KegLineDto():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _KegLineDto value)?  $default,){
final _that = this;
switch (_that) {
case _KegLineDto() when $default != null:
return $default(_that);case _:
...
class _KegLineDto implements KegLineDto {
   _KegLineDto({required this.id, required this.pLye1, required this.mLye1, required this.pLye2, required this.mLye2, required this.mAcid, required this.lyeConcentration1, required this.lyeSoda1, required this.lyeConcentration2, required this.lyeSoda2, required this.acidConcentration, required this.timeStamp});
  factory _KegLineDto.fromJson(Map<String, dynamic> json) => _$KegLineDtoFromJson(json);
...
@pragma('vm:prefer-inline')
_$KegLineDtoCopyWith<_KegLineDto> get copyWith => __$KegLineDtoCopyWithImpl<_KegLineDto>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$KegLineDtoToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _KegLineDto&&(identical(other.id, id) || other.id == id)&&(identical(other.pLye1, pLye1) || other.pLye1 == pLye1)&&(identical(other.mLye1, mLye1) || other.mLye1 == mLye1)&&(identical(other.pLye2, pLye2) || other.pLye2 == pLye2)&&(identical(other.mLye2, mLye2) || other.mLye2 == mLye2)&&(identical(other.mAcid, mAcid) || other.mAcid == mAcid)&&(identical(other.lyeConcentration1, lyeConcentration1) || other.lyeConcentration1 == lyeConcentration1)&&(identical(other.lyeSoda1, lyeSoda1) || other.lyeSoda1 == lyeSoda1)&&(identical(other.lyeConcentration2, lyeConcentration2) || other.lyeConcentration2 == lyeConcentration2)&&(identical(other.lyeSoda2, lyeSoda2) || other.lyeSoda2 == lyeSoda2)&&(identical(other.acidConcentration, acidConcentration) || other.acidConcentration == acidConcentration)&&(identical(other.timeStamp, timeStamp) || other.timeStamp == timeStamp));
}
...
/// @nodoc
abstract mixin class _$KegLineDtoCopyWith<$Res> implements $KegLineDtoCopyWith<$Res> {
  factory _$KegLineDtoCopyWith(_KegLineDto value, $Res Function(_KegLineDto) _then) = __$KegLineDtoCopyWithImpl;
@override @useResult
$Res call({
 int id, double pLye1, double mLye1, double pLye2, double mLye2, double mAcid, double lyeConcentration1, double lyeSoda1, double lyeConcentration2, double lyeSoda2, double acidConcentration, DateTime timeStamp
});
...
/// @nodoc
class __$KegLineDtoCopyWithImpl<$Res>
    implements _$KegLineDtoCopyWith<$Res> {
  __$KegLineDtoCopyWithImpl(this._self, this._then);

  final _KegLineDto _self;
  final $Res Function(_KegLineDto) _then;
