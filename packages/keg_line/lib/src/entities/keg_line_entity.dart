...
class KegLineEntity {
  ...
  @override
  String toString() =>
      'KegLineEntity(id: $id, concentrationAcid: $concentrationAcid, concentrationLyeOne: $concentrationLyeOne, concentrationLyeTwo: $concentrationLyeTwo, mValueLyeOne: $mValueLyeOne, mValueLyeTwo: $mValueLyeTwo, pValueLyeOne: $pValueLyeOne, pValueLyeTwo: $pValueLyeTwo, mValueAcid: $mValueAcid, timestamp: $timestamp)';
}
